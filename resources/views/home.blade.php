        ...
        <div class="page d-flex flex-column flex-column-fluid">
                ...
                <div class="container-xxl d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 w-lg-225px me-5">
                        ...
                        <a href="index.html">
                            ...
                            <img alt="Logo" src="assets/media/logos/logo-dark.svg"
                                class="d-none d-lg-inline h-50px theme-dark-show" />
                            <img alt="Logo" src="assets/media/logos/logo-mobile.svg" class="d-lg-none h-45px" />
                        </a>
                        <!--end::Logo-->
                    </div>
                    <!--end::Brand-->
                                            ...
                                            <div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible"
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="col-lg-6 mb-3">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="dashboards/pos.html" class="menu-link">
                                                                        ...
                                                                        <span class="d-flex flex-column">
                                                                            <span
                                                                                class="fs-6 fw-bold text-gray-800">POS
                                                                                System</span>
                                                                            <span
                                                                                class="fs-7 fw-semibold text-muted">Campaings
                                                                                & conversions</span>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="dashboards/logistics.html"
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                    href="https://preview.keenthemes.com/metronic8/demo5/layout-builder.html"
            ...
            <div id="kt_content_container" class="d-flex flex-column-fluid align-items-stretch container-xxl">
                ...
                <div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
                    ...
                    data-kt-drawer-toggle="#kt_aside_toggle" data-kt-sticky="true"
                    data-kt-sticky-name="aside-sticky" data-kt-sticky-offset="{default: false, lg: '1px'}"
                    data-kt-sticky-width="{lg: '225px'}" data-kt-sticky-left="auto" data-kt-sticky-top="94px"
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5 w-100 ps-4 ps-lg-0 pe-4 me-1"
                        ...
                        <div class="menu menu-column menu-active-bg menu-hover-bg menu-title-gray-700 fs-6 menu-rounded w-100"
                            ...
                            <div class="menu-item pt-5">
                                <div class="menu-content pb-2">
                                    <span
                                        class="menu-section text-muted text-uppercase fs-7 fw-bold">Categories</span>
                                </div>
                            </div>
                            <!--end::Heading-->
                            <!--begin::Menu item-->
                            ...
                            <div class="menu-item">
                                <div class="menu-link">
                                    <a hred="#" class="menu-title text-muted fs-7"
                                        id="kt_aside_categories_toggle" data-bs-toggle="collapse"
                                        data-bs-target="#kt_aside_categories_more">More Categories</a>
                                </div>
                            </div>
                            <!--end::Heading-->
                        </div>
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <a href="apps/devs/question.html"
                                            class="fs-2 fw-bold text-gray-900 text-hover-primary me-1">How to use
                        ...
                        <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                            ...
                            <li class="menu-item">
                                <a href="https://1.envato.market/EA4JP" target="_blank"
                                    class="menu-link ps-2 pe-0">Purchase</a>
                            </li>
                        </ul>
                        <!--end::Menu-->
                    </div>
                ...
                <div class="sidebar p-5 px-lg-0 py-lg-11" data-kt-drawer="true" data-kt-drawer-name="sidebar"
                    ...
                    <!--begin::Quick Search-->
                    <form id="kt_sidebar_search_form" action="apps/devs/search.html"
                    ...
                    <div class="card bg-light mb-5 mb-lg-10 shadow-none border-0">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex mb-5">
                                ...
                                <!--begin::Title-->
                                <a href="apps/devs/question.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">Could not get Metronic Demo
                                    7 working</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Item-->
                    ...
                    <div class="card bg-light mb-5 mb-lg-10 shadow-none border-0">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex mb-5">
                                ...
                                <!--begin::Title-->
                                <a href="apps/devs/question.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">How to use customize
                                    Metronoc's SASS</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex mb-5">
                                ...
                                <!--begin::Title-->
                                <a href="apps/devs/question.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">How to change web font
                                    globally</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex mb-5">
                                ...
                                <!--begin::Title-->
                                <a href="apps/devs/question.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">Metronic file structure and
                                    build tools</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex">
                                ...
                                <!--begin::Title-->
                                <a href="apps/devs/question.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">Metronic integration with
                                    Blazor server side</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Item-->
                        </div>
