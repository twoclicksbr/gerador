                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-4">
                            ...
                            <tbody>
                                    ...
                                    <tr class="{{ $item->trashed() ? 'bg-dark bg-opacity-10' : '' }}">
                                        <td class="ps-4">
                                            <div class="d-flex align-items-center">
                                                <div class="ms-3">
                                                    <a href="{{ route('admin.module.edit', ['module' => 'credential', 'id' => $item->id]) }}"
                                   ...
                                   {{ $item->trashed() ? 'text-gray-500 text-decoration-line-through' : 'text-primary' }}">
                                        ...
                                        <td>
                                            <span class="badge badge-secondary">
                                                {{ $item->dt_limit_access ? \Carbon\Carbon::parse($item->dt_limit_access)->format('d/m/Y') : '—' }}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @elseif ($item->active)
                                                <span class="badge badge-light-success fs-7 fw-bold">Público</span>
                                            @else
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="d-flex justify-content-end">
                                                @if ($item->trashed())
                                                    {{-- Restaurar --}}
                                                    <form
                                                        action="{{ route('admin.module.restore', ['module' => 'credential', 'id' => $item->id]) }}"
                                                        method="POST"
                                                ...
                                                @else
                                                    ...
                                                    <form
                                                        action="{{ route('admin.module.destroy', ['module' => 'credential', 'id' => $item->id]) }}"
                                                        method="POST"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-10">Nenhum registro encontrado.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
