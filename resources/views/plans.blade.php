                                        ...
                                        <th>
                                            ...
                                            <div class="nav bg-light rounded-pill px-3 py-2 ms-9 mb-15 w-225px"
                                                ...
                                                <button
                                                    ...
                                                    data-kt-plan="annual">Annually</button>
                                                <!--end::Nav link-->
                                            </div>
                                            <!--end::Nav group-->
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        <th class="card-rounded-start">
                                            <div class="fw-bold d-flex align-items-center ps-9 fs-3">Sublicense Visuals
                                            </div>
                                        </th>
                                        <td>
                                    ...
                                    <tr>
                                        <th class="card-rounded-start">
                                            <div class="fw-bold d-flex align-items-center ps-9 fs-3">Unlimited Websites
                                            </div>
                                        </th>
                                        <td>
                                            <div class="flex-root d-flex justify-content-center">
