                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="fw-bold d-flex align-items-center fs-5">
                            <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">
                                {{ session('auth_credential.plan.name') ?? 'Sem plano' }}

                            </span>
                            <small class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">
                                ({{ session('auth_credential.plan.payment_cycle') ?? 'Mensal' }})
                            </small>
                        </div>
